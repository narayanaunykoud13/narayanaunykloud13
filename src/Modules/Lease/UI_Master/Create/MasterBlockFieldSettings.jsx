...
function MasterBlockFieldSettings({
    showMasterBlockSettingsDrawer,
    openMasterBlockFieldSettings,
    closeMasterBlockFieldSettingsDrawer,
    addAvailableFields,
    ...
    return (
        <>
            <Drawer
                ...
                width={720}
                onClose={closeMasterBlockFieldSettingsDrawer}
                open={openMasterBlockFieldSettings}
                styles={{
                    body: {
                        paddingBottom: 50,
                    },
                ...
                footer={
                    <Flex align="center" justify="space-between">
                        ...
                        <Button
                            ...
                            className="btn btn-primary"
                            onClick={() => {
                                showMasterBlockSettingsDrawer(true);
                            }}
                        >
                            Main Settings
                        </Button>
            ...
            >
                <div className="settingsInfo">
                    <ul>
                        <li>
                            <span>Block Name :</span> <span>abc</span>
                        </li>
                        <li>
...
export default MasterBlockFieldSettings;