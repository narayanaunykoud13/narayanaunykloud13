...
function ButtonSettings() {
  ...
  const handleButtonHoverStyleChange = (event) => {
    const { name, value } = event.target;
    setButtonHoverStyle((prevStyle) => ({
      ...prevStyle,
      [name]: value,
    }));
  };

  const buttonHoverAllStyle = {
    ...buttonStyle,
    ...(hover !== null && buttonHoverStyle),
  };
    ...
    <>
      <Flex>
        <Link
          ...
          to=""
          style={hover ? buttonHoverAllStyle : buttonStyle}
          className="customPreviewButton"
        >
          Save
        </Link>
      </Flex>
