...
const Amenities = () => {
    ...
    const [colDefs, setColDefs] = useState([
        ...
        { field: "", headerName:"Amenity Name" },
        { field: "", headerName:"Amenity Type" },
        { field: "", headerName:"Description" },
        { field: "", headerName:"Amenity STtatus" },
        { field: "", headerName:"Inactive" },
      ]);
    return (
        <div>
        ...
        <Card title="Amenities">
             <Button className="btn pull-left">Add Amenity</Button>
                <div
