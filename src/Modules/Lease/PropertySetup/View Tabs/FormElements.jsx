                ...
                <Card title="Property Details">
                    <div className="row">
                        <div className="col-md-4">
                            ...
                            <FormControl label="Dropdown Field">
                                <GlobalList readOnly modelName="fields.sunpartofproperty" />
                            </FormControl>
                            ...
                            <FormControl label="Slider Field" border="F">
                                <Slider  readOnly defaultValue={30}/>
                            </FormControl>
                        </div>
                        <div className="col-md-4">
                            <FormControl label="Number field regular">
                        ...
                        <FormControl label="Select Any" type="radio">
                            <Radio.Group defaultValue="a" readOnly>
                                <Radio.Button value="a">Hangzhou</Radio.Button>
                                <Radio.Button value="b">Shanghai</Radio.Button>
                                <Radio.Button value="c">Beijing</Radio.Button>
                                <Radio.Button value="d">Chengdu</Radio.Button>
                            ...
                            <FormControl label="Rate Field">
                                <Rate readOnly allowHalf defaultValue={2.5} />
                            </FormControl>
                            <FormControl label="Checkbox field" border="F">
                                <CheckboxGroup options={plainOptions}  readOnly/>
                            </FormControl>
                        </div>
                        <Checkbox readOnly
                            checked={componentDisabled}
