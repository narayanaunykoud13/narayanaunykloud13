...
const LocalAttractions = () => {
    ...
    const [colDefs, setColDefs] = useState([
        ...
        { field: "", headerName:"Local Attraction" },
        { field: "", headerName:"Description" },
        { field: "", headerName:"Visiting Hours" },
        { field: "", headerName:"	Visiting Days" },
      ]);
    return (
        <div>
        ...
        <Card title="Local Attractions">
             <Button className="btn pull-left">Add Local Attraction</Button>
                <div
