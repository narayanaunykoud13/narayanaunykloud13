...
const BuildingGroups = () => {
    ...
    const [colDefs, setColDefs] = useState([
        ...
        { field: "", headerName:"Floor/Non Floor" },
        { field: "", headerName:"Building/Group Type" },
      ]);
    return (
        <div>
        ...
        <Card title="Building/Groups">
             <Button className="btn pull-left">New Building/Groups</Button>
                <div
