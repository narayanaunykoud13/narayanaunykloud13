...
const Utilities = () => {
    ...
    const [colDefs, setColDefs] = useState([
        ...
        { field: "", headerName:"Utility Name" },
        { field: "", headerName:"Utility Provider Type" },
        { field: "", headerName:"Utility Provider" },
        { field: "", headerName:"Pricing Frequency" },
      ]);
    return (
        <div>
        ...
        <Card title="Property Utilities">
             <Button className="btn pull-left">ADD Utility Item</Button>
                <div
