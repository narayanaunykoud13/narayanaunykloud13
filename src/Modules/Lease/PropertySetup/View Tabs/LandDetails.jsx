...
const LandDetails = () => {
    ...
    const [colDefs, setColDefs] = useState([
        ...
        { field: "", headerName:"Land Group" },
        { field: "", headerName:"Land Code" },
        { field: "", headerName:"Unit Type" },
        { field: "", headerName:"Category" },
        { field: "", headerName:"Area" },
        { field: "", headerName:"Unit Of Measures" },
    ...
    return (
        ...
        <Card title="Land Details">
             <Button className="btn pull-left">Add Land Groups</Button>
                <div
